...
res_0.5 <- DimPlot(harmonized_seurat, group.by = "CCA_snn_res.0.5", label = TRUE)
pdf(paste0(out_dir, "res_0.5.pdf"))
print(res_0.5 + coord_fixed())
mute <- dev.off()
print(res_0.5 + coord_fixed())
res_0.7 <- DimPlot(harmonized_seurat, group.by = "CCA_snn_res.0.7", label = TRUE)
pdf(paste0(out_dir, "res_0.7.pdf"))
print(res_0.7 + coord_fixed())
mute <- dev.off()
res_1 <- DimPlot(harmonized_seurat, group.by = "CCA_snn_res.1", label = TRUE)
pdf(paste0(out_dir, "res_1.pdf"))
print(res_1 + coord_fixed())
mute <- dev.off()
print(res_1 + coord_fixed())
res_1.2 <- DimPlot(harmonized_seurat, group.by = "CCA_snn_res.1.2", label = TRUE)
pdf(paste0(out_dir, "res_1.2.pdf"))
print(res_1.2 + coord_fixed())
mute <- dev.off()
res_1.4 <- DimPlot(harmonized_seurat, group.by = "CCA_snn_res.1.4", label = TRUE)
pdf(paste0(out_dir, "res_1.4.pdf"))
print(res_1.4 + coord_fixed())
mute <- dev.off()
res_2 <- DimPlot(harmonized_seurat, group.by = "CCA_snn_res.2", label = TRUE)
pdf(paste0(out_dir, "res_2.pdf"))
print(res_2 + coord_fixed())
mute <- dev.off()
print(res_2 + coord_fixed())
