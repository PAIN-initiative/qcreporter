...
selected_c = list()
for (sample in samples){
selected_c[[sample]] <- WhichCells(scrna.list_postfilter[[sample]], expression = nUMI < q99_prefilter_median[[sample]])
scrna.list_postfilter[[sample]] <- subset(scrna.list_postfilter[[sample]], cells = selected_c[[sample]])
}
so_postfilter <- Merge_Seurat_List(scrna.list_postfilter,
                                              add.cell.ids = NULL,
                                              merge.data = TRUE,
                                              project = "sample_id")
