...
<!-- Parent document must have a variable "in_dir" containing metadata-injected H5 files by sample --> 
...
all_h5 <- list.files(path = in_dir, 
                               pattern = ".h5$", 
                               full.names = TRUE, recursive = TRUE)
assertthat::assert_that(length(all_h5) >0, 
                        msg = sprintf("Did not detect any .h5 files in input RNA directory %s", in_dir))
```   
