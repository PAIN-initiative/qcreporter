...
for (sample in samples) {
scrna.list[[sample]] <- RenameCells(object = scrna.list[[sample]], add.cell.id = sample)
}
...
scRNA seq report well module v.`r {snrna_seq_sample_module_version}`, Brigham and Women's Bioinformatics and Genomics Hub  
