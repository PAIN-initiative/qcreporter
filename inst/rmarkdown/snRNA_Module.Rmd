...
pdf(paste0(out_dir,"N_Cells_prefilter_postfilter.pdf"))
ggplot(NCellDF, aes(fill=QC_Status, y=N_Cells, x=Sample)) + 
    geom_bar(position="dodge", stat="identity") + geom_text(aes(label=N_Cells), position=position_dodge(width=0.9), vjust=-0.25)
mute <- dev.off()
ggplot(NCellDF, aes(fill=QC_Status, y=N_Cells, x=Sample)) + 
    geom_bar(position="dodge", stat="identity") + geom_text(aes(label=N_Cells), position=position_dodge(width=0.9), vjust=-0.25)
