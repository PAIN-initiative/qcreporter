...
scrna.combined_prefilter <- Merge_Seurat_List(scrna.list,
                                              ...
                                              merge.data = TRUE,
                                              project = "sample_id")
saveRDS(scrna.combined_prefilter,paste0(output_dir,'scrna.combined_prefilter.rds')) # Note this is after removing cells with > 0 % Mitochondrial Transcripts.
...
so_postfilter <- Merge_Seurat_List(scrna.list,
                                              ...
                                              merge.data = TRUE,
                                              project = "sample_id")
saveRDS(so_postfilter,paste0(output_dir,"so_postfilter.rds"))
...
pdf(paste0(output_dir,"ElbowPlot.pdf"))
