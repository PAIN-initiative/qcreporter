...
alldata.int <- FindClusters(alldata.int, graph.name = "CCA_snn", resolution = seq(0.5,3,by=0.1),algorithm = alg,verbose=FALSE)
alldata.int <- RunUMAP(alldata.int, reduction = "pca", dims = 1:20, n.components = 2, n.neighbors = 30,
...
# Save Data
saveRDS(alldata.int,paste0(out_dir,"snRNA_postfilter_int_cl.rds"))
```
```{r echo=FALSE,message=FALSE}
# Set the identity as louvain with resolution 0.5
meta <- alldata.int@meta.data
Idents(alldata.int) <- resolution
# Find Markers
